...
public class LayoutHelper {
    ...
    */
    ...
    public static RelativeLayout.LayoutParams createRelative(Context context,float width, float height, int leftMargin, int topMargin, int rightMargin, int bottomMargin, int alignParent, int alignRelative, int anchorRelative) {
